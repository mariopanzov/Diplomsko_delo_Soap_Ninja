...
public class StartBattleButtonState<T> : BaseState<T> where T : LevelSelectStateManagerScript
{
    private LTSeq seq;
    ...
    {
        state_manager.switchStates(state_manager._start_battle_popup_state);
    }
}