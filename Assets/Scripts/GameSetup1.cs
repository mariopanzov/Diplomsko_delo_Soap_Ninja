...
[CreateAssetMenu]
public class GameSetupp : ScriptableObject
{
    ...
    {
        //sets al the values when the game or script first starts, i am sure that the script doesnt start more than once
        _picked_level = 0;
...
[System.Serializable]
public class GameplaySceneLevelSetupp
{
